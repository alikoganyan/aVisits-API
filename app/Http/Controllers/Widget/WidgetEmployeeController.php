...
class WidgetEmployeeController extends Controller
{
    ...
    public function employee_times(EmployeeTimesFilterRequest $request)
    {
        ...
        return response()->json(['data' => ['employees' => $employeesToArray, "date" => $filters['date'], "working_status" => 1]], 200);
    }
}